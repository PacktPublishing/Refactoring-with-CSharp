...
public class FlightBookingManagerTests {
  ...
  static Passenger GenerateTestPassenger() {
    return new() {
      FirstName = "Dot",
      LastName = "Nette",
  ...
  static FlightInfo GenerateEmptyFlight(string from, string to) {
    return new() {
      Departure = new Airport() { Name = from, Country = "NorthPole", Code = "BA1234" },
      Arrival = new Airport() { Name = to, Country = "SouthPole", Code = "BA1234" },
    };
  }
}
